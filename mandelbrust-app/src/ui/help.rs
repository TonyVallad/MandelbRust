...
use crate::app::{HelpTab, MandelbRustApp};
    ...
    pub(crate) fn show_help_window(&mut self, ctx: &egui::Context) {
        ...
        egui::Window::new("Controls & Shortcuts")
            ...
            .show(ctx, |ui| {
                ...
                ui.horizontal(|ui| {
                    ui.selectable_value(&mut self.help_tab, HelpTab::Controls, "Controls");
                    ui.selectable_value(&mut self.help_tab, HelpTab::Toolbar, "Toolbar Icons");
                });
                ui.separator();
                ...
                match self.help_tab {
                    ...
                    HelpTab::Toolbar => {
                        ...
                        let icons: &[(&str, &str)] = &[
                            ...
                            (ICON_PALETTE, "Display/color settings"),
                            (ICON_PHOTO_CAMERA, "Export image"),
                            (ICON_DEBLUR, "Anti-aliasing menu (Off / 2x2 / 4x4)"),
