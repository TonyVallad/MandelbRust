...
use crate::app::{MandelbRustApp, SettingsTab};
...
impl MandelbRustApp {
    ...
    fn draw_settings_minimap(&mut self, ui: &mut egui::Ui) {
        ui.heading("Minimap");
        ui.horizontal(|ui| {
            ui.label("Size:");
    ...
    fn draw_settings_julia_explorer(&mut self, ui: &mut egui::Ui) {
        ui.heading("Julia C Explorer");
        ui.weak("Square grid (1:1 C aspect), centered in viewport.");
        if ui
            .add(
                egui::Slider::new(
