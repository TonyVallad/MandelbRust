...
pub(crate) struct MandelbRustApp {
    ...
    pub(crate) resume_thumbnail: Option<egui::TextureHandle>,
    pub(crate) mandelbrot_preview: Option<egui::TextureHandle>,
    pub(crate) julia_preview: Option<egui::TextureHandle>,
    pub(crate) bookmarks_preview: Option<egui::TextureHandle>,
